...
describe RoadTripSerializer, type: :serializer do
  ...
  #
  #   # See spec/support/road_trip_response_body.rb for test setup helper method:
  #   #   #road_trip_response_body
  #   let(:road_trip) { RoadTrip.new(road_trip_response_body) }
  #
  ...
  #       expect(road_trip_hash[:data][:type]).to eq(:road_trip)
  #
